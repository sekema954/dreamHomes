...
export const Banner = () => {
    ...
    return(
        ...
        className={`py-4 text-center lg:justify-center px-5 relative ${click ? 'hidden' : 'flex'}`}>
            <p className="text-sm">✨Discover Your Dream Property with Estatein <a className="text-purple-100 text-center" href="/about" aria-label="" about="Learn more">Learn more</a></p>
            <div>
